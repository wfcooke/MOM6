...
use time_manager_mod, only : set_calendar_type, days_in_month, month_name, days_in_year
...
public :: get_date, set_date, increment_date, month_name, days_in_month, days_in_year
